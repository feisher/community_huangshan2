...
public class ChoseTypeAdp extends BaseAdapter {
    private Context mContext;
    private List<Role.RoleListBean.TeacherListBean> titles;
    private LayoutInflater mInflater;

    public ChoseTypeAdp(Context mContext, List<Role.RoleListBean.TeacherListBean> titles) {
