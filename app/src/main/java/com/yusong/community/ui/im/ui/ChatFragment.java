...
import com.yusong.community.ui.im.widget.ChatRowVoiceCall;
...
//                break;
    ...
    public void onSetMessageAttributes(EMMessage message) {
        ...
        UserInfo info = CacheUtils.getUserInfo(getActivity());
        if (info != null){
            //设置要发送扩展消息用户昵称
            message.setAttribute(Constant.USER_NAME, info.getNickname());
            //设置要发送扩展消息用户头像
            message.setAttribute(Constant.HEAD_IMAGE_URL, info.getPortrait());
        }
