...
public class RecorderVideoActivity extends IMBaseActivity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mTitleBar = (EaseTitleBar) findViewById(com.hyphenate.easeui.R.id.title_bar);
		mTitleBar.setTitle("录制视频");
