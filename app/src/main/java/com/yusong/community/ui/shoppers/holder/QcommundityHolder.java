...
/**
 * @author Mr_Peng
 *         created at 2017/3/8 15:18.
 *         抢购商品列表
 */
public class QcommundityHolder extends BaseHolder<CommodityBean> {
    ...
    public QcommundityHolder(View itemView, Context mContext) {
    ...
    public void setData(final List<CommodityBean> datas, final int position) {
        ...
        progressBar.setProgress((int)((double)commodityBean.getSoldAmount()/commodityBean.getAmount())*100);
        ...
        btnBuy.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("isQG", datas.get(position).getId());
