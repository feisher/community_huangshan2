...
import com.yusong.community.utils.interfacecallback.RouterCallback;

import java.io.Serializable;
import java.util.ArrayList;

/**链式路由(用于界面跳转)
 * create by feisher on 2017/1/10 9:45
...
public class Router {
    ...
    private int enterAnim = ActivityConstants.ROUTER_ANIM_ENTER;
    private int exitAnim = ActivityConstants.ROUTER_ANIM_EXIT;
