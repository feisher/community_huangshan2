...
import com.yusong.community.ui.school.teacher.adapter.ChoseParentTypeAdp;
 ...
 */
public class DialogParentTypeTool implements View.OnClickListener {
    private static DialogParentTypeTool mDialogTool;
    ...
    List<Role.RoleListBean.GuardianListBean> mTypeBeans;
    ...
    public static DialogParentTypeTool getInstance() {
        if (null == mDialogTool) {
            mDialogTool = new DialogParentTypeTool();
        }
        return mDialogTool;
    }

    public void initDialog(Context mcontext, View views, List<Role.RoleListBean.GuardianListBean> mTypeBeans) {
...
//        backgroundAlpha(0.5f);
        ...
        ChoseParentTypeAdp mChoseTypeAdp = new ChoseParentTypeAdp(mcontext, mTypeBeans);
            ...
            case R.id.tv_sure:
                ...
                if (pos != -1) {
                    ...
                    if (mOnChooseTypeLinster != null) {
                        mOnChooseTypeLinster.getChooseParentType(pos);
                    }
                } else {
