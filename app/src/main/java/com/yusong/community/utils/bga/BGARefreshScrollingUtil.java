...
public class BGARefreshScrollingUtil {
    ...
    public static boolean isRecyclerViewToBottom(RecyclerView recyclerView, int UpOrDown) {
        if (recyclerView != null) {
            RecyclerView.LayoutManager manager = recyclerView.getLayoutManager();
            ...
            if (manager instanceof LinearLayoutManager) {
                ...
                if (lastVisibleChild != null && UpOrDown > 0 && lastVisibleChild.getVisibility() == View.VISIBLE) {
