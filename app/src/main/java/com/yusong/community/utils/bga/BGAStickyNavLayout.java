...
/**
 */
public class BGAStickyNavLayout extends AutoLinearLayout {
    ...
    private RecyclerView.OnScrollListener mRvOnScrollListener = new RecyclerView.OnScrollListener() {
        ...
        public void onScrollStateChanged(RecyclerView recyclerView, int newState) {
            if ((newState == RecyclerView.SCROLL_STATE_IDLE || newState == RecyclerView.SCROLL_STATE_SETTLING) && mRefreshLayout != null && mRefreshLayout.shouldHandleRecyclerViewLoadingMore(recyclerView,UpOrDown)) {
    ...
    public boolean shouldHandleLoadingMore() {
        ...
        if (mDirectRecyclerView != null) {
            return mRefreshLayout.shouldHandleRecyclerViewLoadingMore(mDirectRecyclerView,UpOrDown);
        }
        ...
        if (mDirectViewPager != null) {
            ...
            if (mNestedRecyclerView != null) {
                return mRefreshLayout.shouldHandleRecyclerViewLoadingMore(mNestedRecyclerView,UpOrDown);
            }
        }
