...
public class EaseConversationAdapter extends ArrayAdapter<EMConversation> {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            convertView = layoutInflr.from(getContext()).inflate(R.layout.ease_row_chat_history, parent, false);
        }
        ...
        if (holder == null) {
            ...
            holder.mDelete = (TextView) convertView
        ...
        holder.mDelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                EventBus.getDefault().post(new RemoveEvent(position));
            }
        });
        // get conversation
