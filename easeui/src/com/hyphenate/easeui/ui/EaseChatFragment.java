...
//        ll_root = (RelativeLayout)getView().findViewById(R.id.ll_root);
    ...
    protected void setUpView() {
        ...
        if (chatType == EaseConstant.CHATTYPE_SINGLE) {
            ...
            if (EaseUserUtils.getUserInfo(toChatUsername) != null) {
                ...
                if (user != null) {
                    if (!toChatUsername.equals(user.getNick())) {
//                        if (mUserName.equals(user.getNick()))
...
//                EaseUI.getInstance().getNotifier().vibrateAndPlayTone(message);  //取消消息声音
            } else {
