...
public class LunarSolarConverter {
     ...
     * 国历节日 *表示放假日
     */
    public final static String[] sFtv = {
     ...
     * 农历节日 *表示放假日
     */
    public final static String[] lFtv = {
    ...
    public final static Pattern sFreg = Pattern.compile("^(\\d{2})(\\d{2})([\\s\\*])(.+)$");
    public final static Pattern wFreg = Pattern.compile("^(\\d{2})(\\d)(\\d)([\\s\\*])(.+)$");
