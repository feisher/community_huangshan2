...
public class CalendarViewPagerAdapter extends FragmentStatePagerAdapter {
    ...
    public CalendarViewPagerAdapter(FragmentManager fm, boolean isChoiceModelSingle, List<Integer>weekList) {
        super(fm);
        this.isChoiceModelSingle = isChoiceModelSingle;
    ...
    public Fragment getItem(int position) {
        ...
        Fragment fragment = CalendarViewFragment.newInstance(year,month,isChoiceModelSingle,weekList);
        return  fragment;
    }
